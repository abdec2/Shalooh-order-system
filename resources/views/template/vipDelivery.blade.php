        ...
        <tbody>
            ...
            <tr>
                <td colspan="2">
                    <p>
                        &nbsp;To:
                        {{ $data['phone'] }}<br />{{ ( isset($data['first_name']) ? $data['first_name'] : '' ) .' '. ( isset($data['last_name']) ? $data['last_name'] : '') }}<br />{{ $data['shipping_address1'] }}<br />{{$data['shipping_address2']}}&nbsp;<br />{{$data['city']}}&nbsp;<br />{{ $data['country']}}
                    </p>
                </td>
            </tr>
            <tr>
